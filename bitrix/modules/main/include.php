...
/*ZDUyZmZMTkxYjM5MGM5NDFiM2IwNDBkYTkxYzgxNDM0ZGU4N2M=*/$GLOBALS['____191594305']= array(base64_decode('Z'.'GVmaW5l'));if(!function_exists(__NAMESPACE__.'\\___1357477058')){function ___1357477058($_2133881154){static $_818720907= false; if($_818720907 == false) $_818720907=array('RU5DT0RF','WQ==');return base64_decode($_818720907[$_2133881154]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1767889164){ return true;} public static function IsFeatureEditable($_1767889164){ return true;} public static function SetFeatureEnabled($_1767889164, $_1471946681= true){} public static function SaveFeaturesSettings($_533694244, $_1765500423){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1653059391){} public static function ModifyFeaturesSettings($_1653059391, $_1419210637){} public static function IsFeatureInstalled($_1767889164){ return true;}} $GLOBALS['____191594305'][0](___1357477058(0), ___1357477058(1));/**/			//Do not remove this
